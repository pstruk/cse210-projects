...
public class ScriptureLibrary 
{
    ...
    private void InitializeLibrary()
    {
        ...
        scriptures.Add(new Scripture(new Reference("Moroni", 10, 5, 6),
        ...
        scriptures.Add(new Scripture(new Reference("Doctrine & Covenants", 98, 11, 12),
        ...
        scriptures.Add(new Scripture(new Reference("Moses", 1, 2),
    ...
    {
        int randomNumber = randomGen.Next(0, scriptures.Count);
        Scripture pickedScripture = scriptures[randomNumber];
